...
| [Regionalized IP Bindings](/data-localization/regional-services/ip-bindings/)         | BYOIP prefix at the IP layer   | Per CIDR / IP prefix               | BYOIP only               | Data Localization Suite API  | GA           | Address-map deployments; regionalizing at the IP layer         |
