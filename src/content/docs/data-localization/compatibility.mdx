...
[^26]: Static IP/BYOIP can be used with Regionalized Spectrum Applications. BYOIP prefixes can also be regionalized at the IP layer with [Regionalized IP Bindings](/data-localization/regional-services/ip-bindings/).
