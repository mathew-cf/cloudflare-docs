...
- [Static IPs](/byoip/concepts/static-ips/) are supported only by Regionalized Spectrum Applications.
...
Managed and custom regions apply to Regional Services. Customer Metadata Boundary and Geo Key Manager use their own region settings. For details, refer to [Region support](/data-localization/region-support/#region-types).
